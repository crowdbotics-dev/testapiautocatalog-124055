...
## Project Structure
    ...
    ├── testapiautocatalog_124055  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_124055`
...
2. Clone this repo and `cd testapiautocatalog_124055`
